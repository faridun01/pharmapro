...
export type SidebarView = 'dashboard' | 'notifications' | 'pos' | 'inventory' | 'batches' | 'purchases' | 'invoices' | 'debtors' | 'customers' | 'suppliers' | 'reports' | 'settings' | 'returns' | 'writeoffs' | 'shifts';
